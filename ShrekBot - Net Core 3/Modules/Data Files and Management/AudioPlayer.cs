...
namespace ShrekBot.Modules.Data_Files_and_Management
{
    ...
    class AudioPlayer
    {
        ...
        /// <summary>
        /// <para>
        /// Async function that handles the playback of the audio. 
        /// This function is technically blocking in it's for loop. 
        /// </para>
        /// 
        ...
        /// While it is playing, these will hold values of the current playback audio.
        /// It will depend on m_Volume for the volume.
        /// In the end, the three are flushed again.
        /// </summary>
        /// <param name="client"></param>
        /// <param name="songPath"></param>
        /// <returns></returns>
        private async Task AudioPlaybackAsync(IAudioClient client, string songPath)
        {
            m_IsRunning = true;
            ...
            m_Process = CreateLocalStream(songPath);
            ...
            while (true)
            {
                ...
                // If something else kills this process, we stop.
        ...
        public bool IsPlaying() => ((m_Process != null) && m_IsPlaying);       
        ...
        public async Task Play(IAudioClient client, string songPath)
        {
            ...
            // Start playback.
            await AudioPlaybackAsync(client, songPath);
        }
