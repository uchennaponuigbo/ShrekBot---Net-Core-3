...
namespace ShrekBot.Modules.Swamp.Modules
{
    ...
    public class ScheduleMessageModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task RestartCmd()
        {
            ...
            string message = $"Donkey! I will shout something at {_service.RepeatingIntervalTimePST} PST. " +
        ...
        [Alias("newtime", "ant")]
        public async Task SetTimeInterval(double newRepeatingInterval, string newIntervalTimeInPST)
        {
            ...
            if (!IsValidTimeFormat(newIntervalTimeInPST))
            {
            ...
            _service.SetMessageTimes(newRepeatingInterval, newIntervalTimeInPST);
            _service.Restart();
        ...
        public async Task TimeZoneBotIsRunningIn()
        {
            ...
            build.WithTitle(localZone.DaylightName);
        ...
        public async Task NextMessageTime()
        {
            ...
            string message = $"I shout the next message every " +
                ...
                $"at {_service.RepeatingIntervalTimePST} PST.";
