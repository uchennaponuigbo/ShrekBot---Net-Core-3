...
namespace ShrekBot.Modules.Swamp.Services
{
    ...
    public class TimerService
    {
        ...
        private readonly int _hour = 18; //11
        private readonly int _minute = 0; //0
        ...
        {
            SetTextChannel(553092290990571535);
            //isPaused = false;
        ...
        private void AssignNewDateToUTC()
        {
            ...
            TimeSpan deltaTime = MessageSentDateTime - current;
            if (deltaTime.TotalMinutes < 0)
            {
                MessageSentDateTime = MessageSentDateTime.AddDays(1);
                deltaTime = MessageSentDateTime - current;
            }
            StartingMessageInMinutes = deltaTime.TotalMinutes;
        }
